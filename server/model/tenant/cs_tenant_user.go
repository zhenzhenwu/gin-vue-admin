...
type CsTenantUser struct {
	...
	TenantAuthorityId *int   `json:"authorityId" form:"authorityId" gorm:"column:authority_id;comment:用户角色ID;size:20;"`
...
// TableName CsTenantUser 表名
func (CsTenantUser) TableName() string {
	return "cs_tenant_users"
}
